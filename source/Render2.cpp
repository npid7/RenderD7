...
std::vector<R2::R2Cmd> R2::commands;
R2Screen R2::current_screen = R2Screen_Bottom;

void R2::Init() { R2::font = new Font(); }

void R2::SetFont(Font& fnt) { R2::font = &fnt; }

Font& R2::GetFont() { return *R2::font; }
...
void R2::AddImage(R7Vec2 pos, Image& img) {
  R2Cmd cmd;
  cmd.pos = pos;
  cmd.img = &img;
  cmd.type = 4;  // Image
